...
// "2023-04-29T19:00:23.180Z"
  ...
  useEffect(() => {
    setChartData({
        ...
        datasets: [
            {
                label: 'No of Comments in Photos and Recipes',
    ...
    setChartOptions({
        plugins: {
            ...
            title: {
                display: true,
                text: 'No of Comments in every 2 Month Period'
            }
        },
...
export default BarChartMonthsComments;
